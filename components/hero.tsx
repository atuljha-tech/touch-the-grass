...
export function Hero() {
  return (
    <div className="relative z-10">
      ...
      {/* ── HERO ── */}
      <section className="flex flex-col items-center justify-center text-center px-6 pt-24 pb-20 min-h-[90vh]">
        ...
        <div className="animate-fade-rise-delay flex flex-wrap items-center justify-center gap-4 mt-10">
          ...
          <span className="text-muted-foreground text-sm">or jump straight to →</span>
          {roles.map((r) => (
      ...
      <section className="px-6 md:px-8 pb-20">
        <div className="max-w-7xl mx-auto">
          <div className="liquid-glass rounded-3xl p-8 md:p-12 bg-white/[0.03]">
      ...
      <section className="px-6 md:px-8 pb-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((f) => (
              <div key={f.title} className="liquid-glass rounded-2xl p-6 bg-white/[0.03] hover:bg-white/[0.05] transition-colors">
      ...
      <section className="px-6 md:px-8 pb-32">
        <div className="max-w-7xl mx-auto">
          <div className="liquid-glass rounded-3xl p-10 md:p-16 bg-white/[0.03] text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {roles.map((r) => (
                <Link key={r.href} href={r.href}>
                  <div className={`liquid-glass rounded-full px-8 py-3 flex items-center gap-2.5 border transition-all hover:scale-[1.03] ${r.color}`}>
